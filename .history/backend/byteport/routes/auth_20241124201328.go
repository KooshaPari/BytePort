...
func LinkHandler(c *gin.Context) {
	...
	fmt.Println(req)
	encryptedPortfolioAPIKey, _ := lib.EncryptSecret(req.Portfolio.APIKey, os.Getenv("ENCRYPTION_KEY"))
	...
	encryptedPortfolioURL, _ := lib.EncryptSecret(req.Portfolio.RootEndpoint, os.Getenv("ENCRYPTION_KEY"))
