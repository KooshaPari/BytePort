...
func ExecuteImgPipeline(AccessKey string, SecretKey string, projectName string, instProfArn string, pipelineArn string )(ec2.ExecuteImgPipelineResponse, error){
	c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
