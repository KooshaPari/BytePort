...
func CreateInfrastructureConfiguration(Acces,Key string, SecretKey string, projectName string, instProf string) (*ec2.CreateInfrastructureConfigurationResponse, error) {
	c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
