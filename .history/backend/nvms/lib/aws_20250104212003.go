...
func CreateContainerRecipe(AccessKey string, SecretKey string, bucket S3DeploymentInfo, service models.Service, componentsinfraConfig string) (*ec2.CreateContainerRecipeResponse, error) {
	c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
