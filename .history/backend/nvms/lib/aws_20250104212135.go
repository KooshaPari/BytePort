...
func CreateContainerRecipe(AccessKey string, SecretKey string, workdir string, service models.Service, components []models.ImageComponent ,targetRepo string) (*ec2.CreateContainerRecipeResponse, error) {
	c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
