...
func CreateContainerRecipe(AccessKey string, SecretKey string, workdir string, components []models.ImageComponent ,targetRepo ContainerRepo) (*ec2.CreateContainerRecipeResponse, error) {
	c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
