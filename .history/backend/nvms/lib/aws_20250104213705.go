...
func CreateImageComponents(AccessKey string, SecretKey string, workdir string, name string,s3Info S3DeploymentInfo, service models.Service, files []string) ([]ec2.CreateImageComponentResponse, error) {
	c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
	...
	if err != nil {
		fmt.Println(err)
		return []ec2.CreateImageComponentResponse{},err
   }
   ...
   components := []ec2.CreateImageComponentResponse{}
