...
func CreateContainerRecipe(AccessKey string, SecretKey string, workdir string, name string, components []ec2.CreateContainerRecipeResponse ,targetRepo ec2.ContainerRepo) (*ec2.CreateContainerRecipeResponse, error) {
	c, err := ec2.NewEC2(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
