...
func PrepareProject(AccessKey string, SecretKey string, project models.Project) (S3DeploymentInfo, , error) {
	...
	ecrRepo,err := CreateECRRepo(accesskey, secretkey, project.Name)
		if err != nil {
	...
	instanceProfile, err := CreateInstanceProfile(accesskey, secretkey, project.Name)
		if err != nil {
