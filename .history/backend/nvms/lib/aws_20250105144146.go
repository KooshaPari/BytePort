...
func PrepareProject(AccessKey string, SecretKey string, name string, codebase []byte) (*S3DeploymentInfo,*ecr.CreateRepositoryResponse,*ec2.CreateInstanceProfileResponse , error) {
