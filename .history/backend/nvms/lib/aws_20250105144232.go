...
func PrepareProject(accessKey string, secretKey string, name string, codebase []byte) (*S3DeploymentInfo,*ec2.CreateInstanceProfileRespons,*ecr.CreateRepositoryResponse , error) {
