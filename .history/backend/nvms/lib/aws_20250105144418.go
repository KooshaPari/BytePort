...
func PrepareProject(accesskey string, accesskey string, name string, codebase []byte) (*S3DeploymentInfo,*ec2.CreateInstanceProfileResponse,*ecr.CreateRepositoryResponse , error) {
