...
func CreateContainerRecipe(AccessKey string, SecretKey string, workdir string, name string, components []ec2.ComponentsConfig ,targetRepo img.ContainerRepo) (*ec2.CreateContainerRecipeResponse, error) {
	c, err := img.NewIMG(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
