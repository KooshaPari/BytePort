...
func CreateInfrastructureConfiguration(AccessKey string, SecretKey string, projectName string, instProf string) (*img.CreateInfrastructureConfigurationResponse, error) {
	c, err := img.NewIMG(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
...
func CreateContainerRecipe(AccessKey string, SecretKey string, workdir string, name string, components []img.ComponentsConfig ,targetRepo img.ContainerRepo) (*ec2.CreateContainerRecipeResponse, error) {
	c, err := img.NewIMG(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
...
func PrepareProject(accesskey string, secretkey string, name string, codebase []byte) (*S3DeploymentInfo,*ec2.CreateInstanceProfileResponse,*ecr.CreateRepositoryResponse , error) {
