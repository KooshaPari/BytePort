...
func CreateInfrastructureConfiguration(AccessKey string, SecretKey string, projectName string, instProf string, sgIds []string, ) (*img.CreateInfrastructureConfigurationResponse, error) {
	c, err := img.NewIMG(aws.Config{
		AccessKeyId: AccessKey,
		SecretAccessKey: SecretKey,
		SessionToken: "",
