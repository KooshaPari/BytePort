...
func (c *Client) CreateContainerRecipe(ctx context.Context) (*CreateImageRecipeResponse, error){}
func (c *Client) DeleteContainerRecipe(ctx context.Context) (*DeRecipeResponse, error){}