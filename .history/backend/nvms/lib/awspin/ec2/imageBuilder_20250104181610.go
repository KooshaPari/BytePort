...
func (c *Client) CreateImageComponent(ctx context.Context, name string, version string, platform string, commands []models.BuildCommand) (*CreateImageComponentResponse, error){
	...
	defer resp.Body.Close()
	c.endpointURL = c.endpointURL[:len(c.endpointURL)-]
