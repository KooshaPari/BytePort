...
func convertBuildpackToComponent(buildpack models.BuildPack, service models.Service) *models.ImageComponent {
    return &models.ImageComponent{
        ...
        Input: struct{
			Commands: []models.BuildCommand{
            // System packages
            {
                Type: "install",
                Commands: buildpack.Packages,
            },
            // Environment setup
            {
                Type: "configure",
                Commands: buildpack.PreBuild,
                EnvVars: buildpack.EnvVars,
            },
            // Build process
            {
                Type: "build",
            ...
            // Service startup
            {
                Type: "configure",
                Commands: []string{
                    fmt.Sprintf("PORT=%d %s", service.Port, buildpack.Start),
                },
            },
        },
	},
