...
func convertBuildpackToComponent(buildpack models.BuildPack, service models.Service) (*models.ImageComponen)t {
	res := &models.ImageComponent{
		Name:        service.Name,
		Version:     "1.0",
