...
func CreateBaseRecipe(components []models.ImageComponent, workingDir string, tags map[string]string) *models.ImageRecipe {
	return &models.ImageRecipe{
		ParentImage: "ami-0c55b159
