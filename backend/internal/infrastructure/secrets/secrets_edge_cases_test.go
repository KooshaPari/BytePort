...
func TestVaultProviderFunctionSignatures(t *testing.T) {
	t.Run("VaultProvider function signatures", func(t *testing.T) {
		...
		// Test function types
		getSecretFunc := provider.GetSecret
		setSecretFunc := provider.SetSecret
		deleteSecretFunc := provider.DeleteSecret
		listSecretsFunc := provider.ListSecrets
...
func TestManagerFunctionSignatures(t *testing.T) {
	t.Run("Manager function signatures", func(t *testing.T) {
		...
		// Test function types
		getSecretFunc := manager.GetSecret
		setSecretFunc := manager.SetSecret
		invalidateCacheFunc := manager.InvalidateCache
		clearCacheFunc := manager.ClearCache
		registerProviderFunc := manager.RegisterProvider
