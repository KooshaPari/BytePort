...
export const rovingTabindex: Action<HTMLElement, RovingTabindexOptions> = (
  node,
  options = {},
) => {
  let opts: RovingTabindexOptions = { orientation: 'vertical', wrap: true, initialIndex: 0, ...options };
